        ...
        for (int j = 0; j < i+1; j++)
        {
                ...
                if (pairs[i].loser == pairs[j].winner)
                {
                    ...
                    if (locked[pairs[j].winner][pairs[j].loser] == true)
                    {
                        ...
                        if (recursion(pairs[i].winner, pairs[i].winner) == true)
                        {
...
bool recursion(int w, int l)
{
    ...
    // check the previous is locked
        ...
        {
            // checks if previous pair loser is the same as new pair winner
            if (pairs[i].loser == w)
            {
                // checks if previous pair winner is the same as new pair loser
